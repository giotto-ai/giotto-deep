...
class SAB(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, ln=False, bias_attention=True, activation='gelu'):
        super().__init__()
...
class ISAB(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, num_inds, ln=False, bias_attention=True,
        ...
        self.mab0 = MAB(dim_out, dim_in, dim_out, num_heads, ln=ln, bias_attention=bias_attention, activation=activation)
        self.mab1 = MAB(dim_in, dim_out, dim_out, num_heads, ln=ln, bias_attention=bias_attention, activation=activation)
...
class PMA(nn.Module):
    def __init__(self, dim, num_heads, num_seeds, ln=False, bias_attention=True,
        ...
        self.mab = MAB(dim, dim, dim, num_heads, ln=ln, bias_attention=bias_attention, activation=activation)
