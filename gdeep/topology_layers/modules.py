...
class _SAB(nn.Module):
    def __init__(
        ...
        self.mab = _MAB(
            ...
            simplified_layer_norm=simplified_layer_norm,
        )
...
class _FastAttention(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, *, heads=8, dim_head=64):
        ...
        self.to_q_attn_logits = nn.Linear(
            dim_head, 1, bias=False
    ...
    def forward(self, x):
        ...
        q_attn_logits = (
            rearrange(self.to_q_attn_logits(q), "b h n () -> b h n") * self.scale
        )
        ...
        k_attn_logits = (
            rearrange(self.to_k_attn_logits(k), "b h n () -> b h n") * self.scale
        )
